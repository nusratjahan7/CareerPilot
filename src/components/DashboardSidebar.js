    ...
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-50 h-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transition-all duration-300 flex flex-col
          ...
          w-64`}
      >
        <div className={`flex items-center gap-3 px-4 py-4 border-b border-gray-200 dark:border-gray-800 ${collapsed ? "justify-center lg:justify-center" : "justify-between"}`}>
          {!collapsed && (
